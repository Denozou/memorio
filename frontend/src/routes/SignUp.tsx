            ...
            <main className="mx-auto max-w-md px-4 sm:px-6 py-12 sm:py-16">
                ...
                <div className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/60 shadow-lg p-6 sm:p-8">
                    <form onSubmit={onSubmit} className="space-y-5">
                        {/* Display Name Input */}
                        <div>
                            <label htmlFor="displayName" className="block text-sm font-medium text-slate-900 dark:text-slate-50 mb-2">
                                Display Name
                            </label>
                            <input
                                id="displayName"
                        ...
                        <div>
                            <label htmlFor="confirmPassword" className="block text-sm font-medium text-slate-900 dark:text-slate-50 mb-2">
                                Confirm Password
                            </label>
                            <div className="relative">
                                <input
